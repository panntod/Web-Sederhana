...
const EditStyle = () => {
    ...
    let panjang = Math.min(Math.max(parseInt(panjangInput.value), parseInt(panjangInput.min)), parseInt(panjangInput.max));
    let lebar = Math.min(Math.max(parseInt(lebarInput.value), parseInt(lebarInput.min)), parseInt(lebarInput.max));
